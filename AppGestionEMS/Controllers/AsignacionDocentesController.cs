...
namespace AppGestionEMS.Controllers
{
    ...
    public class AsignacionDocentesController : Controller
    {
        ...
        {
            var asignacionDocentes = db.AsignacionDocentes.Include(a => a.Curso).Include(a => a.GrupoClase);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.GrupoClaseId = new SelectList(db.GrupoClases, "Id", "Grupo");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,CursoId,GrupoClaseId,UserId")] AsignacionDocentes asignacionDocentes)
        {
            ...
            ViewBag.GrupoClaseId = new SelectList(db.GrupoClases, "Id", "Grupo", asignacionDocentes.GrupoClaseId);
            return View(asignacionDocentes);
        }
